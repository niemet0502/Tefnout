  ...
  return (
    <header className="header clearfix">
		...
		<div className="header_right">
			<ul>
				<li>
					{/* {user.profil_id == 1 ? '' : <Link to="/new-course"> <Button text="Nouveau cours" /> </Link>  } */}
				...
				<li className="ui dropdown">
					...
					<div className="menu dropdown_account transition">
						<div className="channel_my">
							...
							<a href="my_instructor_profile_view.html" className="dp_link_12">{ user.profil_id == 1 ? 'Administrateur' : 'Formateur'} Profile</a>						
						</div>
						...
						<button className="item channel_item col-md-12 bg-white" onClick={() => onLogout()}>Se deconnecter</button>
					</div>
					}
